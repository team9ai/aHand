...
fn hello_auth_payload_is_canonical_for_known_input() {
    ...
    assert_eq!(
        payload,
        vec![
            97, 104, 97, 110, 100, 45, 104, 117, 98, 0, 104, 101, 108, 108, 111, 45, 97, 117, 116,
            104, 0, 8, 0, 0, 0, 100, 101, 118, 105, 99, 101, 45, 55, 5, 0, 0, 0, 48, 46, 49, 46,
            50, 3, 0, 0, 0, 109, 98, 112, 5, 0, 0, 0, 109, 97, 99, 111, 115, 2, 0, 0, 0, 4, 0, 0,
            0, 101, 120, 101, 99, 7, 0, 0, 0, 98, 114, 111, 119, 115, 101, 114, 7, 0, 0, 0, 0, 0,
            0, 0, 123, 210, 44, 197, 143, 1, 0, 0, 3, 0, 0, 0, 120, 121, 122
        ]
    );
}
